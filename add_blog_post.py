...
blog_full = readFile("posts\\blog-post.html")
...
blog_full = blog_full.replace("[img-url]",img_url)
blog_full = blog_full.replace("[video-url]",video_url)
...
writeFile("posts\\" + ID + ".html",blog_full)
blog_full = readFile("posts\\" + ID + ".html")
...
posts = readFile("index.html")    
post_ad = f"<div class=&quot;col-md-10 col-lg-8&quot;><div class=&quot;post-preview&quot;><a href=&quot;[link]&quot;><h2 class=&quot;post-title&quot;>[title]</h2><h3 class=&quot;post-subtitle&quot;>[little-desc]</h3></a><p class=&quot;post-meta&quot;>Editor&nbsp;<a href=&quot;#&quot;>{uname}</a> and Posted on [date] at [time]</p></div><hr></div>"
post_ad = post_ad.replace("&quot;",'"')
post_ad = post_ad.replace("[link]","posts/" + str(ID) + ".html")
